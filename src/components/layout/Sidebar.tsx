...
const NAV_ITEMS = [
  ...
  { to: '/equipment',   icon: HeartPulse,      label: 'Équipements médicaux' },
...
export default function Sidebar() {
  ...
  return (
    <aside className={cn(
      ...
      {/* Logo */}
      <div className={cn(
        'flex items-center h-14 px-4 border-b border-gray-100 flex-shrink-0',
        ...
        {settings.logoUrl ? (
          ...
          <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-gradient-to-br from-violet-600 to-violet-800 flex items-center justify-center shadow-md">
      ...
      {/* Compliance badge */}
      {!sidebarCollapsed && (
        <div className="mx-3 mb-3 p-3 rounded-xl bg-gradient-to-br from-violet-50 to-blue-50 border border-violet-100 flex-shrink-0">
          <div className="flex items-center gap-2 mb-1">
            <Shield className="w-3.5 h-3.5 text-violet-600" />
            <span className="text-xs font-semibold text-violet-700">Conformité globale</span>
          </div>
